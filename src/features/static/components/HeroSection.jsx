    ...
    <section className="min-h-screen bg-[#FFFBF1] w-full text-[#1a1a1a]">
      ...
      <div className=" md:grid-cols-3 gap-8 w-full px-[6%] py-16 md:py-24 mx-auto max-w-7xl items-start">
        ...
        <div className="md:col-span-2 space-y-8 flex flex-col justify-center items-center w-full mx-auto">
          <p className="font-sans text-base sm:text-lg text-stone-600 leading-relaxed tracking-wide text-center max-w-2xl mx-auto">
          ...
          <button className="bg-gray-900 text-stone-200 font-bold px-8 py-4 transition-all duration-300 hover:bg-stone-900 hover:text-white hover:scale-105 active:scale-95 shadow-md rounded-lg">
            Contact Me
          </button>
        </div>
      </div>
